...
`b563f405880f1ea7430e958416713ab050ffe887`. Pool expansion and isolated diagnostic
helper added first; native config/engine wiring and server one-step remain
pending. The diagnostic uses a detached copy, no RNG, and does not modify
training gradients. Existing default spread loss is unmodified.
